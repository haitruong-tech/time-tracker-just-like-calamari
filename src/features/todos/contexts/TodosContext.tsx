...
import { type Todo, type ITodoActionsContext, type AddTodoActionPayload } from '../types/todo'
...
function TodosProvider ({ children }: TodosProviderProps): JSX.Element {
  ...
  const handleSwithPosition = (sourceTodoID: string, targetTodoID: string): void => {
    dispatch({
